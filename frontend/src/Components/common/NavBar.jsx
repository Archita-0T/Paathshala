...
import logo from "../../assets/Logo/PaathshalaLogo.png";
  ...
  return (
    ...
    >
      <div className="flex w-11/12 max-w-maxContent items-center justify-between">
        ...
        >
          <img src={logo} width={160} alt="Paathshala" height={50}></img>
        </Link>
        {/* mobile Navbar */}
        ...
        <div className="flex-row gap-5 hidden md:flex items-center">
          ...
          {token == null && (
            ...
            >
              <button className="rounded-[8px] bg-yellow-50  px-[12px] py-[7px] text-black hover:bg-richblack-900 hover:text-white ">
                Login
              </button>
            </Link>
          )}
